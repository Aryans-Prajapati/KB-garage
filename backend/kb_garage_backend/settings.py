...
SECRET_KEY = 'django-insecure-kb-garage-india-secret-key-super-secure'
...
ROOT_URLCONF = 'kb_garage_backend.urls'
...
WSGI_APPLICATION = 'kb_garage_backend.wsgi.application'
