...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "primary", size = "md", children, ...props }, ref) => {
    ...
    const variants = {
      primary:
        "bg-secondary hover:bg-secondary-dark text-on-secondary shadow-[0_4px_12px_rgba(225,29,72,0.3)] hover:shadow-[0_6px_16px_rgba(225,29,72,0.45)] hover:-translate-y-0.5",
      secondary:
